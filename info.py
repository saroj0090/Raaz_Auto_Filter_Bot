...
BOT_TOKEN = environ.get('BOT_TOKEN', "7862229930:AAFSKlzIILYa9KSRRj_VPioEAKKKPWS78cU")    # Bot token from @BotFather
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster1") # Database name (default: cluster)
